...
| `crowdsec-web-ui` | entrypoint fournisseur | `CHOWN`, `SETGID`, `SETUID` pour initialiser les données et basculer vers `bun` | rootfs RO, données applicatives persistantes, `/tmp` tmpfs |

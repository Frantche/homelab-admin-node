...
healthy before running `ghcr.io/frantche/gitea-backup-restore-process:0.3.53`; if either
...
| `backup.gitea_process.image` | `ghcr.io/frantche/gitea-backup-restore-process:0.3.53` | Backup container image. |

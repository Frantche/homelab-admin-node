...
running `ghcr.io/frantche/gitea-backup-restore-process:0.3.17`; if either
...
| `backup.gitea_process.image` | `ghcr.io/frantche/gitea-backup-restore-process:0.3.17` | Backup container image. |

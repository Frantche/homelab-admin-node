...
healthy before running `ghcr.io/frantche/gitea-backup-restore-process:0.3.51`; if either
...
| `backup.gitea_process.image` | `ghcr.io/frantche/gitea-backup-restore-process:0.3.51` | Backup container image. |

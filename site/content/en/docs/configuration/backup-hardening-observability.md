...
healthy before running `ghcr.io/frantche/gitea-backup-restore-process:0.3.46`; if either
...
| `backup.gitea_process.image` | `ghcr.io/frantche/gitea-backup-restore-process:0.3.46` | Backup container image. |
